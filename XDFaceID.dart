...
class XDFaceID extends StatelessWidget {
  XDFaceID({
    Key key,
  }) : super(key: key);
  @override
          ...
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(108.5, 0.0, 66.0, 28.0),
                    size: Size(284.0, 79.0),
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'Face ID' (text)
                        Text(
                      'Face ID',
                      style: TextStyle(
                  ...
                  Pinned.fromSize(
                    ...
                    child:
                        ...
                        Text(
                      'Access your account with Apple’s Face ID instead of your password.',
                      style: TextStyle(
                        fontFamily: 'Circular-Book',
                        fontSize: 14,
                        color: const Color(0xffd9ddee),
